...
export default function TestimonialComponent(props) {
  return (
    <div className="max-w-[450px] mx-auto min-h-[400px] flex flex-col items-center justify-center gap-6 text-white text-center">
      <div
      ...
      <p className="text-sm line-clamp-5 sm:line-clamp-none">{props.message}</p>
      <div>
